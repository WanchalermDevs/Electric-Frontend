...
@Component({
  selector: 'app-habitat-table',
  templateUrl: './habitat-table.component.html',
  styleUrls: ['./habitat-table.component.css']
})
export class HabitatTableComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.dataTable = {
      headerRow: [ 'ห้อง/ร้าน', 'ชั้น', 'อาคาร', 'ประเภท', 'ดำเนินการ' ],
      footerRow: [ 'ห้อง/ร้าน', 'ชั้น', 'อาคาร', 'ประเภท', 'ดำเนินการ' ],
